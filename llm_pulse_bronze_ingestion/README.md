# llm_pulse_bronze_ingestion

This folder defines all source code for the 'llm_pulse_bronze_ingestion' pipeline:
...
* Take a look at the sample under "sample_users_llm_pulse_bronze_ingestion.py" to get familiar with the syntax.
