# llm_pulse_transformations

This folder defines all source code for the 'llm_pulse_transformations' pipeline:
...
* Take a look at the sample under "sample_users_llm_pulse_transformations.py" to get familiar with the syntax.
